...
@app.route('/<string:lot_id>', methods=['GET', 'POST'])
def upload_file(lot_id):
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            respo=requests.post("https://tucultivo.herokuapp.com/lots/"+lot_id+"/get_info",
                        data={},
            ...
            for i in surcos:
                for j in range(int(plantas[cont])):
                    filenamen=str(farm)+'_'+lot_id+'_'+str(i)+'_'+str(j)+'.jpg'
    ...
    <form method=post enctype=multipart/form-data>
        Seleccione la carpeta que contenga las fotos de las plantas del lote <lot_id> de su cultivo<br> 
        <br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
